        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('proyectos.sprints.update', [$proyecto, $sprint]) }}">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="objetivo" name="objetivo"
                                rows="3"
                                class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm text-sm">{{ old('objetivo', $sprint->objetivo) }}</textarea>
